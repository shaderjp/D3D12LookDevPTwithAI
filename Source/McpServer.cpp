...
std::string BuildActionsSchemaJson()
{
  ...
  "actions": [
    ...
    {"method":"set_material","description":"Override one material by index or name, including glTF extension factors and texture slot overrides.","inputSchema":{"type":"object","properties":{"index":{"type":"integer"},"name":{"type":"string"},"baseColor":{"type":"array","items":{"type":"number"},"minItems":4,"maxItems":4},"emissive":{"type":"array","items":{"type":"number"},"minItems":4,"maxItems":4},"roughness":{"type":"number"},"metallic":{"type":"number"},"occlusionStrength":{"type":"number"},"normalStrength":{"type":"number"},"alphaCutoff":{"type":"number"},"alphaMasked":{"type":"boolean"},"packedORM":{"type":"boolean"},"gltfExtensions":{"type":"object","properties":{"featureMask":{"type":"integer","minimum":0},"specularFactor":{"type":"number","minimum":0,"maximum":2},"specularColorFactor":{"type":"array","items":{"type":"number"},"minItems":3,"maxItems":3},"ior":{"type":"number","minimum":1,"maximum":3},"transmissionFactor":{"type":"number","minimum":0,"maximum":1},"thicknessFactor":{"type":"number","minimum":0},"attenuationColor":{"type":"array","items":{"type":"number"},"minItems":3,"maxItems":3},"attenuationDistance":{"type":"number","minimum":0},"clearcoatFactor":{"type":"number","minimum":0,"maximum":1},"clearcoatRoughnessFactor":{"type":"number","minimum":0,"maximum":1},"clearcoatNormalScale":{"type":"number","minimum":0,"maximum":2}},"additionalProperties":false},"textures":{"type":"object","properties":{"baseColor":{"type":"string"},"normal":{"type":"string"},"roughness":{"type":"string"},"metallic":{"type":"string"},"occlusion":{"type":"string"},"emissive":{"type":"string"},"alpha":{"type":"string"},"specularColor":{"type":"string"},"specularFactor":{"type":"string"},"transmission":{"type":"string"},"thickness":{"type":"string"},"clearcoat":{"type":"string"},"clearcoatRoughness":{"type":"string"},"clearcoatNormal":{"type":"string"}},"additionalProperties":false},"clearTextures":{"type":"array","items":{"oneOf":[{"type":"integer"},{"type":"string"}]}},"resetToSource":{"type":"boolean"}},"additionalProperties":false}},
    {"method":"set_material_texture","description":"Set, clear, reset, or transform one material texture slot.","inputSchema":{"type":"object","properties":{"index":{"type":"integer"},"name":{"type":"string"},"slot":{"oneOf":[{"type":"integer"},{"type":"string"}]},"path":{"type":"string"},"uvSet":{"type":"integer","minimum":0,"maximum":1},"offset":{"type":"array","items":{"type":"number"},"minItems":2,"maxItems":2},"scale":{"type":"array","items":{"type":"number"},"minItems":2,"maxItems":2},"rotation":{"type":"number"},"sampler":{"type":"string","enum":["linearRepeat","linearClamp","linearMirror","nearestRepeat","nearestClamp","nearestMirror"]},"resolutionPolicy":{"type":"string","enum":["auto","source","4k","2k","1k","512"]},"clear":{"type":"boolean"},"resetToSource":{"type":"boolean"}},"required":["slot"],"additionalProperties":false}},
    ...
    {"method":"set_view","description":"Set active debug view and display toggles.","inputSchema":{"type":"object","properties":{"debugView":{"type":"integer","minimum":0,"maximum":58},"normalMapYFlip":{"type":"boolean"},"environmentEnabled":{"type":"boolean"}},"additionalProperties":false}}
  ]
})json";
}
